...
<Steps>
  <Step title="Log in to your dashboard" title-type="p">
    Go to <a href="https://www.5centscdn.net/dashboard/login" target="_blank" rel="noopener noreferrer">5centscdn.net/dashboard</a> and sign in.
  </Step>

  <Step title="Open API Keys" title-type="p">
    Navigate to **Settings → API Keys**.
  </Step>

  <Step title="Copy or generate your key" title-type="p">
